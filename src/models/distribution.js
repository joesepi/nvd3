nv.models.distribution = function () {
    ...
    function chart(selection) {
        ...
        selection.each(function (data) {
            var availableLength = width - (axis === 'x' ? margin.left +
            ...
            var wrap = container.selectAll('g.nv-distribution')
                .data([data]);
            ...
            renderWatch.transition(distWrap.exit()
                .selectAll('line.nv-dist' + axis), 'dist exit')
            // .transition()
            .attr(axis + '1', function (d, i) {
            ...
            dist
                .attr('class', function (d, i) {
                    return 'nv-dist' + axis + ' nv-dist' + axis + '-' +
                        i
                })
                .attr(naxis + '1', 0)
                .attr(naxis + '2', size);
