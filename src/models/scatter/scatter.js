nv.models.scatter = function () {
    ...
    function chart(selection) {
        ...
        selection.each(function (data) {
            ...
            if (padData && data[0])
                x.range(xRange || [(availableWidth * padDataOuter +
                        availableWidth) / (2 * data[0].values.length),
                    availableWidth - availableWidth * (1 + padDataOuter) /
            ...
            function updateInteractiveLayer() {
                ...
                var vertices = d3.merge(data.map(function (group,
                    groupIndex) {
                    return group.values
              ...
              [width + 10, -10]
                    ...
                    var mouseEventCallback = function (d, mDispatch) {
                        ...
                        mDispatch({
                            point: point,
                            series: series,
                            pos: [x(getX(point, d.point)) + margin.left,
           ...
           */
                    ...
                    .on('click', function (d, i) {
                        ...
                        dispatch.elementClick({
                            point: point,
                            series: series,
                            pos: [x(getX(point, i)) + margin.left,
            ...
            if (onlyCircles) {
                ...
                points.enter()
                    ...
                    .attr('transform', function (d, i) {
                        return 'translate(' + x0(getX(d, i)) + ',' + y0(
                            getY(d, i)) + ')'
                    })
                    .attr('d',
                        d3.svg.symbol()
    ...
    chart.highlightPoint = function (seriesIndex, pointIndex, isHoverOver) {
        d3.select(".nv-chart-" + id + " .nv-series-" + seriesIndex +
            " .nv-point-" + pointIndex)
            .classed("hover", isHoverOver);
    };

    dispatch.on('elementMouseover.point', function (d) {
        if (interactive) chart.highlightPoint(d.seriesIndex, d.pointIndex,
            true);
    });
