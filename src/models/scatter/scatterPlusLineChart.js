nv.models.scatterPlusLineChart = function () {
    ...
    var showTooltip = function (e, offsetElement) {
        ...
        if (tooltip !== null)
            nv.tooltip.show([left, top], tooltip(e.series.key, xVal, yVal, e.point
                    .tooltip, e, chart), e.value < 0 ? 'n' : 's', null,
                offsetElement);
    };
    ...
    function chart(selection) {
        ...
        selection.each(function (data) {
            ...
            var wrapEnter = wrap.enter()
                .append('g')
                .attr('class', 'nvd3 nv-wrap nv-scatterChart nv-chart-' +
                    scatter.id());
            ...
            gEnter.append('g')
                .attr('class', 'nv-regressionLinesWrap');
            gEnter.append('g')
            ...
            var regWrap = wrap.select('.nv-regressionLinesWrap')
            ...
            regLine
                ...
                .style('stroke-opacity', function (d, i) {
                    return (d.disabled || typeof d.slope ===
                        'undefined' || typeof d.intercept ===
                        'undefined') ? 0 : 1
                });
            ...
            if (showXAxis) {
                xAxis
                    .scale(x)
                    .ticks(xAxis.ticks() ? xAxis.ticks() : availableWidth /
                        100)
            ...
            if (showYAxis) {
                yAxis
                    .scale(y)
                    .ticks(yAxis.ticks() ? yAxis.ticks() : availableHeight /
                        36)
            ...
            if (showDistY) {
                ...
                g.select('.nv-distributionY')
                    .attr('transform', 'translate(' + (rightAlignYAxis ?
                        availableWidth : -distY.size()) + ',0)')
                    .datum(data.filter(function (d) {
                        return !d.disabled
                    }))
                    .call(distY);
