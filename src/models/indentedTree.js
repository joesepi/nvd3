        ...
        selection.each(function (data) {
            ...
            .data(function (d) {
                return d.filter(function (d) {
                    return (filterZero && !d.children) ? filterZero(
                        d) : true;
                })
            }, function (d, i) {
            ...
            columns.forEach(function (column, index) {
                ...
                var nodeName = nodeEnter.append('td')
                    .style('padding-left', function (d) {
                        return (index ? 0 : d.depth * childIndent +
                            12 + (icon(d) ? 0 : 16)) + 'px'
                    }, 'important') //TODO: check why I did the ternary here
                .style('text-align', column.type == 'numeric' ? 'right' :
                    'left');
                ...
                if (column.showCount) {
                    ...
                    node.selectAll('span.nv-childrenCount')
                        .text(function (d) {
                            var returnMe;

                            if ((d.values && d.values.length) || (d._values && d._values.length)) {
                              returnMe = '(' + ((d.values && (d.values.filter(
                                        function (d) {
                                            return filterZero ?
                                                filterZero(d) :
                                                true;
                            ...
                            return ((d.values && d.values.length) ||
                                (d._values && d._values.length)) ? //If this is a parent
