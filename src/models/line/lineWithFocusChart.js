nv.models.lineWithFocusChart = function () {
    ...
    function chart(selection) {
        selection.each(function (data) {
            ...
            var that = this,
                ...
                availableHeight1 = (canvas.options.size.height || parseInt(
                    canvas.svg.style('height')) || 400) -
            ...
            var focusEnter = canvas.gEnter.append('g')
                .attr('class', 'nv-focus');
            focusEnter.append('g')
            ...
            var contextEnter = canvas.gEnter.append('g')
            ...
            if (canvas.options.showLegend) {
                ...
                if (canvas.margin.top != legend.height()) {
                    ...
                    availableHeight1 = (canvas.options.size.height ||
            ...
            canvas.g.select('.nv-context')
                .attr('transform', 'translate(0,' + (availableHeight1 +
                    canvas.margin.bottom + margin2.top) + ')');

            var contextLinesWrap = canvas.g.select(
                '.nv-context .nv-linesWrap')
                .datum(data.filter(function (d) {
                    return !d.disabled
                }));

            d3.transition(contextLinesWrap)
                .call(lines2);
            ...
            var brushBG = canvas.g.select('.nv-brushBackground')
                .selectAll('g')
            ...
            function onBrush() {
                ...
                // Update Main (Focus)
                var focusLinesWrap = canvas.g.select(
                ...
                canvas.g.select('.nv-focus .nv-x.nv-axis')
                    ...
                    .duration(transitionDuration)
                    .call(xAxis);
                canvas.g.select('.nv-focus .nv-y.nv-axis')
                    .transition()
                    .duration(transitionDuration)
                    .call(yAxis);
            }
    ...
    d3.rebind(chart, lines, 'defined', 'isArea', 'size', 'xDomain', 'yDomain',
        'xRange', 'yRange', 'forceX', 'forceY',
