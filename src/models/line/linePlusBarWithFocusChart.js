nv.models.linePlusBarWithFocusChart = function () {
    ...
    var showTooltip = function (e, offsetElement) {
        ...
        var left = e.pos[0] + (offsetElement.offsetLeft || 0),
            ...
            y = (e.series.bar ? y1Axis : y2Axis)
                .tickFormat()(lines.y()(e.point, e.pointIndex)),
    ...
    function chart(selection) {
        selection.each(function (data) {
            ...
            var availableWidth = (width || parseInt(container.style('width')) ||
                ...
                availableHeight1 = (height || parseInt(container.style(
            ...
            x2.domain(d3.extent(d3.merge(series1.concat(series2)), function (
                d) {
                return d.x
            }))
            ...
            var wrap = container.selectAll('g.nv-wrap.nv-linePlusBar')
                .data([data]);
            ...
            var focusEnter = gEnter.append('g')
                .attr('class', 'nv-focus');
            focusEnter.append('g')
                .attr('class', 'nv-x nv-axis');
            focusEnter.append('g')
                .attr('class', 'nv-y1 nv-axis');
            focusEnter.append('g')
            ...
            var contextEnter = gEnter.append('g')
            ...
            contextEnter.append('g')
                .attr('class', 'nv-linesWrap');
            contextEnter.append('g')
                .attr('class', 'nv-brushBackground');
            contextEnter.append('g')
                .attr('class', 'nv-x nv-brush');
            ...
            bars2Wrap.transition()
                .call(bars2);
            lines2Wrap.transition()
                .call(lines2);
            ...
            var brushBG = g.select('.nv-brushBackground')
                .selectAll('g')
            ...
            function onBrush() {
                ...
                focusBarsWrap.transition()
                    .duration(transitionDuration)
                    .call(bars);
                focusLinesWrap.transition()
                    .duration(transitionDuration)
                    .call(lines);
