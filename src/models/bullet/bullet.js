        ...
        selection.each(function (data, i) {
            ...
            var rangez = ranges.call(this, data, i)
                ...
                measurez = measures.call(this, data, i)
                    .slice()
                    .sort(d3.descending),
                rangeLabelz = rangeLabels.call(this, data, i)
                    .slice(),
                markerLabelz = markerLabels.call(this, data, i)
                    .slice(),
                measureLabelz = measureLabels.call(this, data, i)
                    .slice();
            ...
            canvas.gEnter.append('rect')
                .attr('class', 'nv-range nv-rangeMax');
            canvas.gEnter.append('rect')
                .attr('class', 'nv-range nv-rangeAvg');
            canvas.gEnter.append('rect')
                .attr('class', 'nv-range nv-rangeMin');
            canvas.gEnter.append('rect')
                .attr('class', 'nv-measure');
            canvas.gEnter.append('path')
            ...
            canvas.g.select('rect.nv-measure')
                ...
                .attr('width', measurez < 0 ? x1(0) - x1(measurez[0]) : x1(
                    measurez[0]) - x1(0))
                .attr('x', xp1(measurez))
                ...
                canvas.g.selectAll('path.nv-markerTriangle')
                    ...
                    .on('mouseover', function () {
                        dispatch.elementMouseover({
                            ...
                            pos: [x1(markerz[0]), availableHeight /
                                2]
                        })
                    })
                    .on('mouseout', function () {
            ...
            canvas.wrap.selectAll('.nv-range')
                .on('mouseover', function (d, i) {
                    var label = rangeLabelz[i] || (!i ? "Maximum" : i ==
                        1 ? "Mean" : "Minimum");
                    dispatch.elementMouseover({
                        value: d,
                        label: label,
