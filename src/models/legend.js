            ...
            if (align) {
                ...
                series.each(function (d, i) {
                    ...
                    try {
                        ...
                        if (nodeTextLength <= 0) throw new Error();
                    } catch (e) {
                        nodeTextLength = nv.utils.calcApproxTextWidth(
                            legendText);
                    }
                ...
                series
                    .attr('transform', function (d, i) {
                        return 'translate(' + xPositions[i %
                            seriesPerRow] + ',' + (5 + Math.floor(i /
                            seriesPerRow) * 20) + ')';
                    });
                ...
                height = margin.top + margin.bottom + (Math.ceil(
                    seriesWidths.length / seriesPerRow) * 20);
                ...
                series
                    .attr('transform', function (d, i) {
                        ...
                        if (width < margin.left + margin.right + xpos +
                            length) {
                            newxpos = xpos = 5;
                            ypos += 20;
                        }
