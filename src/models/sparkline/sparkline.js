        ...
        selection.each(function (data) {
            ...
            var points = canvas.wrap.selectAll('circle.nv-point')
                .data(function (data) {
                    ...
                    var maxPoint = pointIndex(yValues.lastIndexOf(y.domain()[
                        1])),
                        minPoint = pointIndex(yValues.indexOf(y.domain()[
                            0])),
                        currentPoint = pointIndex(yValues.length - 1);
                    return [minPoint, maxPoint, currentPoint].filter(
                        function (d) {
                            return d !== null;
                        });
                });
            ...
            points
                ...
                .attr('class', function (d) {
                    return getX(d, d.pointIndex) == x.domain()[1] ?
                        ...
                        'nv-point nv-minValue' : 'nv-point nv-maxValue'
                });
        });
