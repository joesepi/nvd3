...
nv.utils.calcApproxTextWidth = function (svgTextElem) {
    if (typeof svgTextElem.style === 'function' && typeof svgTextElem.text ===
        'function') {
...
nv.utils.renderWatch = function (dispatch, duration) {
    ...
    this.transition = function (selection, args, duration) {
        ...
        if (duration === 0) {
            ...
            selection.delay = function () { /*console.warn('`delay` not specified for selection.');*/
                return this;
            };
            selection.duration = function () { /*console.warn('`duration` not specified for selection.');*/
                return this;
            };
            return selection;
        } else {
